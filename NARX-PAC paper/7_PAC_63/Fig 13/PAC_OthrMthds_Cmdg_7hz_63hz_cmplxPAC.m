...
phs_freq = reshape(Phs_Amp(flow_MI==7,:,:), size(Phs_Amp,2), size(Phs_Amp,3) );
...
% ===============================
% Use the following code snippet to save the workspace for plotting and simulation

% save_file_name = '7-63_pinknoise';
...
[max_corr_phi_prb , max_corr_ind_phi_pprb] = max(xcorr_val);
F_phs = phi_prb(max_corr_ind_phi_pprb);
end
