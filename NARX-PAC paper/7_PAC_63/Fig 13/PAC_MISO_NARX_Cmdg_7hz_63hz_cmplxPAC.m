%PAC_MISO_NARX_CMDG_7HZ_63HZ_CMPLXPAC Compute the NARX-PAC results for Figure 13.
%   A 7 Hz sinusoid is coupled with a 63 Hz sinusoid using non-sinusoidal
%   amplitude modulation. The script adds pink noise, calculates the NARX-PAC
%   maps, and applies harmonic- and intermodulation-related post-processing.
%
