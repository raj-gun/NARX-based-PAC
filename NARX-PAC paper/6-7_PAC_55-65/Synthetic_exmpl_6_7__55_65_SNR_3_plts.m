%SYNTHETIC_EXMPL_6_7__55_65_SNR_3_PLTS Assemble the Figure 15 signal and method-comparison panels.
%   The script regenerates the 6-7 Hz by 55-60 Hz synthetic PAC signal,
%   loads saved NARX-PAC and conventional-method outputs, and formats the
%   time trace, spectrum, and comodulograms for publication.
%
clear;clc;close all;
